          ...
          {registrationMethod === 'mobile' && (
            <View style={styles.cleanFormContainer}>
                ...
                <>
                  ...
                  >
                    {loading ? (
                      ...
                      <Text style={styles.cleanSubmitButtonText}>Send OTP</Text>
                    )}
                  </TouchableOpacity>
                </>
              ) : (
                <>
                  ...
                  >
                    {loading ? (
                      ...
                      <Text style={styles.cleanSubmitButtonText}>Verify & Sign In</Text>
                    )}
                  </TouchableOpacity>

                  <TouchableOpacity
                    style={styles.cleanBackToMobileButton}
                    onPress={() => setShowOtpInput(false)}
                    activeOpacity={0.7}
                  >
                    <Text style={styles.cleanBackToMobileText}>← Back to mobile input</Text>
                  </TouchableOpacity>
                </>
              )}
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Ionicons name="mail" size={20} color="#FF1493" />
                <Text style={styles.cleanMethodSwitchText}>Use email address</Text>
              </TouchableOpacity>
            </View>
          )}

          {/* Sign In Method Selection */}
          {registrationMethod !== 'email' && registrationMethod !== 'mobile' && (
            <View style={styles.cleanOptionsContainer}>
              {/* Email Address */}
              <TouchableOpacity
                style={styles.cleanOption}
              ...
              >
                ...
                <View style={styles.cleanOptionContent}>
                  <Text style={styles.cleanOptionTitle}>Mobile Number</Text>
                  <Text style={styles.cleanOptionDescription}>Sign in with your phone</Text>
                </View>
                <Ionicons name="chevron-forward" size={20} color="#999999" />
              </TouchableOpacity>
