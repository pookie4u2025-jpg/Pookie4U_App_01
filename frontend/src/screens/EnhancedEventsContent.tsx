...
export default function EnhancedEventsContent() {
  ...
  const loadEvents = async (loadMore: boolean = false) => {
    ...
    try {
      const apiUrl = process.env.EXPO_PUBLIC_BACKEND_URL || 'https://pookie-connect-1.preview.emergentagent.com';
