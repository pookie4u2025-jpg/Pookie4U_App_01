...
✅ **Backend accessible:** https://streaky-couples-app.preview.emergentagent.com
...
- Test: `curl https://streaky-couples-app.preview.emergentagent.com/api/gifts`
...
- Add redirect URI to Google Cloud Console:
  ```
  https://streaky-couples-app.preview.emergentagent.com
  ```
